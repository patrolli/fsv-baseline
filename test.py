...
from models.MENet import FS_MENet, FS_ResNet
import torch
import numpy as np
...
data_mgr = SetDataManager(args.n_way, args.k_shot, args.q_query, args.test_episode)
...
# TODO: 修改测试函数,在 C3D 模型内部写一个 test_loop(), 输出 dist